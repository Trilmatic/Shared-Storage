        ...
        <tbody v-else>
          ...
          <tr v-if="parent">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="icon icon-tabler icon-tabler-arrow-back-up w-8 h-8"
                viewBox="0 0 24 24"
                stroke-width="1.5"
                stroke="currentColor"
                fill="none"
          ...
          <tr class="border-b" v-if="!uploadLoading">
            <td class="px-6 py-4" colspan="5">
              <div class="w-full flex gap-2">
                <button
                  class="text-primary hover:text-white hover:bg-primary transition-colors rounded-lg p-1"
                  @click="newFolder"
                  :disabled="folderName.length < 3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="icon icon-tabler icon-tabler-circle-plus w-8 h-8"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
                    stroke="currentColor"
                    fill="none"
          ...
          <tr
            class="border-b hover:bg-gray-200 hover:cursor-pointer"
            v-for="f in files"
            :key="f.id"
            @click="resolveRowClick(f)"
          >
            <td class="px-6 py-4 flex items-center gap-2">
              <span v-if="f.isFolder"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-folder-filled w-8 h-8"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  stroke="currentColor"
                  fill="none"
            ...
            <td class="px-6 py-4">{{ f.parentId }}</td>
